...
# Habitat-Smi and Replica dataset debug for zliu and Oskar

You can generate depth and rgbd image using ./examples_debug/navigation.py

python3 ../examples_debug/navigation.py --scene your_dir/ReplicaData/hotel_0/habitat/mesh_semantic.ply --save_png --depth_sensor --max_frames 30

The ./examples_debug/warpimage.ipynb is the warp image implementation followed by this [tutorial](https://aihabitat.org/docs/habitat-lab/view-transform-warp.html), but this is incorrect because it fulfills the unseen area. 

Some example images and its position and rotation are in ./examples_debug/data
